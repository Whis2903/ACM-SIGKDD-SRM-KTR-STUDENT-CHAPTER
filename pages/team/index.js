...
const TeamHome = () => {
  ...
  let miniSearch = new MiniSearch({
    fields: [
      "displayName","uid","collegeEmail","year","batch","bio","learning","skills",'acm',"github","linkedin","website","instagram","photoURL","createdAt","regComplete","priority","admin","role",], // fields to index for full-text search
    storeFields: [
      "displayName","uid","collegeEmail","year","batch","bio","learning","skills",'acm',"github","linkedin","website","instagram","photoURL","createdAt","regComplete","priority","admin","role",], // fields to return with search results
    searchOptions: {
      boost: { displayName: 2 },
      fuzzy: 0.2,
      prefix: true
