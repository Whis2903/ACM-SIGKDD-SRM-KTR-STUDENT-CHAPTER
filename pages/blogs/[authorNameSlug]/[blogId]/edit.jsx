...
import {getBlog} from "../../../../src/firebase/blogData";
...
const CreateNewPost = () => {
    ...
    useEffect(() => {
        ...
        if(user.webRole != 'admin'){
            if (authorNameSlug != user?.gfg.split("/")[4]) {
                router.push('/');
                return;
            }
        }
    ...
    useEffect(() => {
        ...
        setCoverImageInput(post?.coverImage);
        setSavedPost(post);
    }, [post]);
                                        ...
                                        <h1 className={'text-md font-regular w-fit rounded-lg'}>
                                            {
                                                savedPost?.published ?
                                                    <>
                                                        { `Published on ${formatDate(savedPost?.publishedTime)}` }
                                                    </>
                                                    :
                                                    <>
                                                        {
