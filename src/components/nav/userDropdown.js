  ...
  return (
    <div className="relative inline-block">
      ...
      <div className="relative hidden md:flex flex-col m-auto">
        <button
          className="relative z-10 flex items-center justify-center text-sm text-gray-600 bg-white border border-transparent rounded-md  dark:text-white dark:bg-gray-800  w-fit outline outline-offset-2 outline-purple-600 hover:outline-dashed rounded-full"
          onClick={() => {
            setIsOpen(!isOpen);
          }}
        >
